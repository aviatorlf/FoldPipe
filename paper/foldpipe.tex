...
\small Affiliation and ORCID to be confirmed\\
\small \url{https://github.com/aviatorlf/FoldPipe}}
...
utilities~\cite{pygondiskdocs,pygloaderdocs}; Hugging Face supports iterable
streaming~\cite{huggingfacestreaming}; and WebDataset uses streaming tar
...
from local or remote storage~\cite{aizman2020webdataset}.  Hugging Face Datasets
offers iterable streaming, sharding, and buffered shuffle for supported dataset
formats~\cite{huggingfacestreaming}.  FoldPipe's distinction is compatibility,
...
artifact~\cite{khatri2026foldpipe,khatri2026artifact}.
...
licensed~\cite{khatri2026foldpipe}.
